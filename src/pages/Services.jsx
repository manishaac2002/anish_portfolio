  ...
  return (
    <div className="blueContainer ">
      ...
      <div className="flex justify-center">
        {/* services button */}
        <div className="relative border-b-2 border-gray-300 w-3/4 h-6 md:h-28">
    ...
    <div className="mt-1 md:mt-8 lg:mt-20 md:grid md:gap-8 grid-cols-2 xl:grid xl:grid-cols-4 md:mx-20">
      {/* skills */}
